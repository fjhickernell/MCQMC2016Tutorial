...
constant functions.  The deterministic discrepancy is defined as \marginpar{This is just a suggestion. Would it be interesting to add one sentence here providing the idea/purpose of considering $L$?}
...
$L^2$-discrepancy.
\marginpar{I cannot follow the legend item $K(x,0.3)$. Is it the black line on Fig.1, left plot? It dos not seem to match.}
\begin{figure}
	\centering
