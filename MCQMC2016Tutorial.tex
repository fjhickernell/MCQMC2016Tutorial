...
\begin{figure}
	\centering
	 \includegraphics[height=4cm]{ProgramsImages/UnwtL2Disc.eps} \qquad 
	 \includegraphics[height=4cm]{ProgramsImages/UnwtL2DiscLat.eps}  
	\caption{The root mean square $L^2$ discrepancies given by \eqref{FJH:eq:L2disc} 
	for randomly scrambled and shifted Sobol' sequences points and randomly shifted 
	lattice sequence nodesets.  A variety of dimensions are shown.
