...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
% Requires L2Kernel.eps, LocalDiscrep.eps, IIDPoints.eps, ShiftedLatticePoints.eps, 
...
variable $\bsX$ has probability measure $\nu$.  \marginpar{Changed "Monte Carlo" by "These"}These methods approximate 
...
\end{equation}
where the $\delta_{\bst}$ denotes a Dirac measure concentrated at the point $\bst$. \marginpar{Concentrated "at the point" or "at point"?} 
...
the sum\marginpar{Sum or average?}
...
\marginpar{I do not follow this equality. Are you using your definition of $\std(f)$?}
\begin{equation*}
...
\marginpar{I am not sure about this derivation but I get something of $\std_{\hnu}^2$ instead of $\corr^2$.}
\[
...
\section{A Randomized Trio Identity for Cubature Error}
