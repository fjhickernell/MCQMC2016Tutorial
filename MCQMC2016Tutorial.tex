...
\begin{figure}
	...
	\includegraphics[height=5cm]{ProgramsImages/USobolPoints.eps} \qquad
...
\begin{figure}
	\centering
	  \includegraphics[height=4cm]{ProgramsImages/UnwtL2DiscLat.eps}   \qquad 
	  \includegraphics[height=4cm]{ProgramsImages/UnwtL2Disc.eps} 
...
l_{jk}\Phi^{-1}(\alpha_k + x_k(\beta_k-\alpha_k))\right)\right), \ j =2, \ldots, d, \\
f(\bsx) &= \prod_{j=1}^{d} [\beta_j(\bsx) - \alpha_j(\bsx)].
\end{align*}
...
\begin{figure}
	\centering
	\includegraphics[width = 5cm]{ProgramsImages/MVNIIDUSobolSobol.eps} \qquad 
	\includegraphics[width = 5cm]{ProgramsImages/MVNSobolGenzAff.eps}
...
\begin{equation*}
\bsz = \bsa + (\bsb-\bsa) \circ \bsx, \quad g(\bsx) =  \frac{\exp\bigl(- 
\frac 12 \bsz^T
\mathsf{\Sigma}^{-1} \bsz 
	\bigr)}{\sqrt{(2 \pi)^d \det(\mathsf{\Sigma})}} \, \prod_{j=1}^d (b_j - a_j), \quad \mu = 
	\int_{[0,1]^{d}} g(\bsx) \, \D \bsx,
\end{equation*} 
...
two convergence rates are the same.  Difference in the magnitudes of the errors is 
mainly because $\Var^{\Dt}(g)$ is greater than $\Var^{\Dt}(f)$.  This illustrates another 
...
\begin{figure}
	\centering
		\includegraphics[width = 5.5cm]{ProgramsImages/AsianCallIIDUSobolSobol.eps} 
		\qquad
		\includegraphics[width = 5.5cm]{ProgramsImages/AsianCallSobolPCADiff.eps}
...
\begin{figure}
	\centering
	\includegraphics[height=4cm]{ProgramsImages/WtL2DiscLat.eps}   \qquad 
	\includegraphics[height=4cm]{ProgramsImages/WtL2Disc.eps} 
