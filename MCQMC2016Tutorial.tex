...
\end{equation}
where the $\delta_{\bst}$ denotes a Dirac measure concentrated at point $\bst$. 
...
simple sum: $\mu = N^{-1} \sum_{j=1}^N f(j)$, where $f(j)$ denotes the hours of sleep of 
individual 
