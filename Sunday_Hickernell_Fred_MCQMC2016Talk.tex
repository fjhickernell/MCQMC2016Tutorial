...
\begin{frame}
	...
	\begin{itemize}
		...
		\item For \alert{digital net} (e.g., Sobol') and \alert{integration lattice} sampling, rigorous stopping criteria have been constructed in terms of the discrete Fourier Walsh/complex exponential coefficients of $f$ \smallcites{HicJim16a, JimHic16a, Li16a}
	\end{itemize}
\end{frame}
