...
\begin{frame}
	...
	\vspace*{-4ex}
	A \alert{random} $f$ has been postulated by \cite{Dia88a}, \cite{OHa??}, \cite{Rit00a}  and others.
	Suppose that $f \sim \GP (0, s^2C)$,  a \alert{Gaussian process} in the sample space $\cf$ with zero mean and covariance kernel $C:\cx \times \cx \to \reals$.  Let $S : \cf \to \reals$ be linear with
